...
async function generateImage4() {
    ...
    setTimeout(async function() {
        try {
            ...
            console.log('이미지 4 생성 완료');
            saveToLocalStorage();
        } catch (error) {
            console.error('generateImage4 에러:', error);
        }
    }, 100);
}
...
async function generateImage5() {
    ...
    setTimeout(async function() {
        try {
            ...
            console.log('이미지 5 생성 완료');
            saveToLocalStorage();
        } catch (error) {
            console.error('generateImage5 에러:', error);
        }
    }, 100);
}
...
async function generateImage7() {
    ...
    setTimeout(async function() {
        try {
            ...
            console.log('이미지 7 생성 완료');
            saveToLocalStorage();
        } catch (error) {
            console.error('generateImage7 에러:', error);
        }
    }, 100);
}
...
async function generateImage8() {
    ...
    setTimeout(async function() {
        try {
            ...
            console.log('이미지 8 생성 완료');
            saveToLocalStorage();
        } catch (error) {
            console.error('generateImage8 에러:', error);
        }
    }, 100);
}
